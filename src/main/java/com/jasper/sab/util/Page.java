...
public class Page {
	...
	public Page(int start, long count, int pageSize, List<?> result) {
		this.start = start;
		this.count = count;
		this.pageSize = pageSize;
		this.result = result;
	}
	public Page(int start, long count, int pageSize) {
		this(start, count, pageSize, new ArrayList<Object>());
	}
	public Page(int start, long count) {
